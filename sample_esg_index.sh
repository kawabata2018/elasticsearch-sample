...
curl -XPUT http://localhost:9200/sample_esg/_doc/1?pretty -H 'Content-Type: application/json' -d '
{
  "document_id": 1,
...
curl -XPUT http://localhost:9200/sample_esg/_doc/2?pretty -H 'Content-Type: application/json' -d '
{
  "document_id": 2,
  "document_name": "環境ビジョン・方針",
  "company_id": 1,
...
curl -XPUT http://localhost:9200/sample_esg/_doc/3?pretty -H 'Content-Type: application/json' -d '
{
  "document_id": 3,
  "document_name": "環境ビジョン・方針",
  "company_id": 1,
...
curl -XPUT http://localhost:9200/sample_esg/_doc/4?pretty -H 'Content-Type: application/json' -d '
{
  "document_id": 4,
...
curl -XPUT http://localhost:9200/sample_esg/_doc/5?pretty -H 'Content-Type: application/json' -d '
{
  "document_id": 5,
  "document_name": "地球温暖化防止等に向けた取り組み",
  "company_id": 2,
